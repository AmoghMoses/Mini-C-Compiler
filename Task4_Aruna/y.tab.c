...
const int YY_parse_CLASS::value=259;
const int YY_parse_CLASS::bool=260;
const int YY_parse_CLASS::LOW_BOOL_OP=261;
const int YY_parse_CLASS::EQUALS=262;
const int YY_parse_CLASS::LOW_OP=263;
const int YY_parse_CLASS::HIGH_OP=264;
const int YY_parse_CLASS::HIGH_BOOL_OP=265;
const int YY_parse_CLASS::IF=266;
const int YY_parse_CLASS::ELSE=267;
const int YY_parse_CLASS::l_b=268;
const int YY_parse_CLASS::r_b=269;
const int YY_parse_CLASS::l_c=270;
const int YY_parse_CLASS::r_c=271;
const int YY_parse_CLASS::X=272;
const int YY_parse_CLASS::TYPE=273;
const int YY_parse_CLASS::WHILE=274;
const int YY_parse_CLASS::COMMA=275;
...
static const short yyprhs[] = {     0,
     0,     3,     5,     6,    16,    20,    22,    25,    28,    30,
    32,    34,    36,    37,    40,    42,    43,    46,    50,    55,
    59,    61,    63,    65,    68,    73,    78,    82,    84,    88,
    90,    92,    94,    98,   100,   104,   106,   108,   110,   114,
   118,   119,   128,   129
};

static const short yyrhs[] = {    22,
    21,     0,    22,     0,     0,    23,    18,     3,    13,    24,
    14,    15,    26,    16,     0,    24,    20,    25,     0,    25,
     0,    18,     3,     0,    27,    26,     0,    27,     0,    34,
     0,    41,     0,    42,     0,     0,    28,    44,     0,    31,
     0,     0,    29,    30,     0,    15,    26,    16,     0,     3,
    13,    32,    14,     0,    32,    20,    33,     0,    33,     0,
     3,     0,     4,     0,    18,     3,     0,    18,     3,     7,
    35,     0,    18,     3,     7,    38,     0,    35,     8,    36,
     0,    36,     0,    36,     9,    37,     0,    37,     0,     3,
     0,     4,     0,    38,     8,    39,     0,    39,     0,    39,
     9,    40,     0,    40,     0,     3,     0,     5,     0,     3,
     7,    35,     0,     3,     7,    38,     0,     0,    11,    13,
    38,    14,    15,    43,    26,    16,     0,     0,    19,    13,
    38,    14,    15,    26,    45,    16,     0
};
...
static const short yyrline[] = { 0,
    35,    36,    38,    38,    40,    41,    43,    45,    46,    48,
    49,    50,    51,    51,    52,    53,    53,    55,    57,    59,
    60,    62,    63,    65,    66,    67,    69,    76,    78,    85,
    87,    88,    90,    97,    99,   106,   108,   109,   111,   116,
   122,   122,   124,   125
};

static const char * const yytname[] = {   "$","error","$illegal.","id","value",
"bool","LOW_BOOL_OP","EQUALS","LOW_OP","HIGH_OP","HIGH_BOOL_OP","IF","ELSE",
"l_b","r_b","l_c","r_c","X","TYPE","WHILE","COMMA","PROGRAM","FUNCTION","@1",
"ARGUMENTS","ARGUMENT","LINES","LINE","@2","@3","BLOCK","FUNCTION_CALL","ARGS",
"ARG","DECLARATION","ARITH_EXP","ARITH_TERM","ARITH_FACTOR","BOOLEAN_EXP","BOOLEAN_TERM",
"BOOLEAN_FACTOR","ASSIGNMENT","CONDITIONAL","@4","LOOP","@5",""
};
#endif

static const short yyr1[] = {     0,
    21,    21,    23,    22,    24,    24,    25,    26,    26,    27,
    27,    27,    28,    27,    27,    29,    27,    30,    31,    32,
...
static const short yydefact[] = {     3,
     2,     0,     1,     0,     0,     0,     0,     0,     6,     7,
     0,     0,    13,     5,     0,     0,     0,     0,     9,     0,
     0,    15,    10,    11,    12,     0,     0,     0,    24,     4,
     8,     0,    14,    13,    17,    31,    32,    38,    39,    28,
    30,    40,    34,    36,    22,    23,     0,    21,    37,     0,
     0,     0,     0,     0,     0,     0,     0,    19,     0,     0,
    25,    26,     0,    18,    31,    27,    29,    33,    35,    20,
    41,     0,    13,    13,     0,    43,    42,     0,    44,     0,
     0,     0
};

static const short yydefgoto[] = {     3,
     1,     2,     8,     9,    18,    19,    20,    21,    35,    22,
    47,    48,    23,    39,    40,    41,    42,    43,    44,    24,
    25,    73,    33,    78
};

static const short yypact[] = {-32768,
    15,    16,-32768,    32,    23,    20,    34,   -11,-32768,-32768,
    24,    20,     1,-32768,    -2,    27,    38,    26,    -1,    29,
    30,-32768,-32768,-32768,-32768,    25,    19,     3,    36,-32768,
-32768,    31,-32768,     1,-32768,-32768,-32768,-32768,    39,    37,
-32768,    41,    42,-32768,-32768,-32768,    -7,-32768,-32768,    12,
    25,     3,    40,    28,    28,     3,     3,-32768,    19,    35,
    39,    41,    13,-32768,-32768,    37,-32768,    42,-32768,-32768,
-32768,    43,     1,     1,    44,-32768,-32768,    45,-32768,    52,
    53,-32768
};

static const short yypgoto[] = {    57,
-32768,-32768,-32768,    47,   -19,-32768,-32768,-32768,-32768,-32768,
-32768,     4,-32768,    11,    10,    14,   -27,     9,    17,-32768,
...
static const short yytable[] = {    31,
    50,    15,    11,    15,    26,    49,    58,    38,    12,    16,
    27,    16,    59,   -16,    53,   -16,    17,   -13,    17,    56,
    56,    45,    46,    62,    63,    60,    72,    36,    37,    38,
    65,    37,    -3,     4,     5,     6,    10,     7,    13,    28,
    29,    30,    51,    52,    34,    55,    54,    32,    56,    71,
    57,    81,    82,    75,    76,    64,    80,    74,    14,    77,
    79,    61,    70,    66,    68,     0,     0,     0,    67,     0,
     0,     0,     0,    69
};

static const short yycheck[] = {    19,
    28,     3,    14,     3,     7,     3,    14,     5,    20,    11,
    13,    11,    20,    15,    34,    15,    18,    19,    18,     8,
     8,     3,     4,    51,    52,    14,    14,     3,     4,     5,
     3,     4,    18,    18,     3,    13,     3,    18,    15,    13,
     3,    16,     7,    13,    15,     9,     8,    19,     8,    15,
     9,     0,     0,    73,    74,    16,     0,    15,    12,    16,
    16,    51,    59,    54,    56,    -1,    -1,    -1,    55,    -1,
    -1,    -1,    -1,    57
};
...
case 25:
#line 66 "parser.y"
{assignment(yyvsp[-2].lexeme, yyvsp[0].lexeme); yyval.lexeme = yyvsp[-3].lexeme; ;
    break;}
case 26:
#line 67 "parser.y"
{assignment(yyvsp[-2].lexeme, yyvsp[0].lexeme); yyval.lexeme = yyvsp[-3].lexeme;;
